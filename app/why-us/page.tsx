...
export default function WhyUsPage() {
    ...
    return (
        <div className={`min-h-screen ${isDark ? 'bg-[#0D211A] text-slate-200' : 'bg-white text-black'} font-sans selection:bg-amber-500/30`}>
            {/* Background Glows */}
            ...
            {/* Navigation */}
            <nav className={`fixed top-0 left-0 right-0 z-50 ${isDark ? 'bg-[#0D211A]/80 border-white/5' : 'bg-white/80 border-black/5'} backdrop-blur-xl border-b`}>
            ...
            <main className="pt-32 pb-20 px-6 relative z-10 w-full">
                <div className="max-w-6xl mx-auto flex flex-col items-center">
                    ...
                    <div className="text-center space-y-8">
                        ...
                        <Link
                            href="/?auth=signup"
                            className="inline-block px-12 py-6 bg-white text-black hover:bg-amber-500 hover:text-white rounded-full text-lg font-black uppercase tracking-[0.2em] transition-all duration-300 shadow-[0_0_40px_rgba(255,255,255,0.1)] hover:shadow-[0_0_60px_rgba(20,61,51,0.3)] hover:scale-105"
                        >
                            Get Started
                        </Link>
                    </div>
