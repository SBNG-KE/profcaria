    ...
    <tr className="border-b border-white/5 hover:bg-white/[0.02] transition-colors group">
        <td className="py-4 px-6">
            <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-[#ED3EB3]/10 border border-[#ED3EB3]/20 flex items-center justify-center text-[#35D7DC] font-bold text-xs">
                    {data.name.charAt(0)}
                </div>
        ...
        <td className="py-4 px-6">
            <span className={`px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider ${data.status === 'Active' ? 'bg-[#ED3EB3]/10 text-[#35D7DC] border border-[#ED3EB3]/20' :
...
export default function BackupsPage() {
    ...
    return (
        <div className="p-8 h-full flex flex-col bg-[#061D20]">
            <div className="max-w-7xl mx-auto w-full space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button className="flex items-center gap-2 px-6 py-2.5 bg-[#ED3EB3] hover:bg-[#ED3EB3] text-white text-xs font-bold rounded-xl shadow-lg shadow-[#ED3EB3]/20 transition-all active:scale-95">
                            <Download size={16} />
                ...
                {/* Toolbar */}
                <div className="flex flex-col md:flex-row gap-4 items-center justify-between p-4 bg-[#061D20]/50 border border-white/5 rounded-2xl backdrop-blur-md">
                    <div className="relative w-full md:w-96">
                        <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500" size={16} />
                        <input
                            type="text"
                            placeholder="Search data records..."
                            className="w-full bg-slate-900/50 border border-slate-700/50 rounded-xl pl-10 pr-4 py-2 text-xs text-slate-200 focus:outline-none focus:ring-2 focus:ring-[#ED3EB3]/50 transition-all"
                            value={searchTerm}
                ...
                {/* Table Area */}
                <div className="bg-[#061D20]/30 border border-white/5 rounded-[32px] overflow-hidden flex-1 shadow-2xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="p-6 bg-[#ED3EB3]/5 border border-[#ED3EB3]/10 rounded-[24px]">
                        <div className="flex items-center gap-3 mb-4">
                            <div className="p-2 bg-[#ED3EB3]/20 rounded-lg text-[#35D7DC]"><FileSpreadsheet size={20} /></div>
