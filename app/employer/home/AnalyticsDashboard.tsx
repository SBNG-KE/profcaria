                ...
                <div className={`border p-8 rounded-[32px] ${isDark ? 'bg-neutral-900 border-neutral-800' : 'bg-white border-neutral-200 shadow-sm'}`}>
                    ...
                    <div className={`mt-10 p-4 rounded-xl border ${isDark ? 'bg-neutral-900/50 border-neutral-800' : 'bg-neutral-50 border-neutral-200'}`}>
                        <div className="flex items-start gap-3">
                            <Zap className="shrink-0 mt-0.5" size={16} color={isDark ? '#64E5E8' : '#77877F'} />
                            <div>
                    ...
                    <AreaChart data={data.trendData}>
                        <defs>
                            <linearGradient id="colorCount" x1="0" y1="0" x2="0" y2="1">
                                <stop offset="5%" stopColor={isDark ? "#FBF8F0" : "#081812"} stopOpacity={0.3} />
                                <stop offset="95%" stopColor={isDark ? "#FBF8F0" : "#081812"} stopOpacity={0} />
                            </linearGradient>
                        </defs>
                        <XAxis dataKey="date" axisLine={false} tickLine={false} tick={{ fill: isDark ? '#587565' : '#CFC4B3', fontSize: 10 }} />
                        <Tooltip contentStyle={{ backgroundColor: isDark ? '#081812' : '#FBF8F0', border: isDark ? '1px solid #153027' : '1px solid #F4F0E6', borderRadius: '12px', color: isDark ? '#FBF8F0' : '#081812' }} />
                        <Area type="monotone" dataKey="count" stroke={isDark ? "#FBF8F0" : "#081812"} strokeWidth={3} fillOpacity={1} fill="url(#colorCount)" />
                    </AreaChart>
                </ResponsiveContainer>
            </div>
                            ...
                            <div className="flex items-center gap-8">
                                <div className="relative w-32 h-32">
                                    <svg className="w-full h-full -rotate-90">
                                        <circle cx="64" cy="64" r="56" fill="none" stroke={isDark ? '#153027' : '#F4F0E6'} strokeWidth="12" />
                                        <circle
                                            cx="64" cy="64" r="56" fill="none"
                                            stroke={isDark ? '#FBF8F0' : '#081812'} strokeWidth="12"
