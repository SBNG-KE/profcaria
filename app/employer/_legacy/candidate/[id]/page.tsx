...
export default async function ViewCandidatePage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <div className="min-h-screen bg-[#FBF8F0] dark:bg-black pb-20">
            ...
            <div className="relative h-56 overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-[#FBF8F0] dark:from-black to-transparent" />
            </div>
