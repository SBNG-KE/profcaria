      ...
      <div className="mx-auto flex min-h-screen max-w-[1600px]">
        ...
        <section className="flex min-h-screen w-full max-w-md flex-col border-r border-[#e5e9f2] bg-white md:w-[390px]">
          <header className="px-6 pb-4 pt-7">
            <div className="flex items-center justify-between"><div><p className="text-xs font-bold uppercase tracking-[0.18em] text-[#72809a]">Ondwira</p><h1 className="mt-1 text-2xl font-black tracking-tight">Messages</h1></div><button className="grid h-11 w-11 place-items-center rounded-2xl bg-[#14213d] text-white shadow-lg shadow-[#14213d]/15" aria-label="Start a new chat"><MessageCirclePlus size={19} /></button></div>
