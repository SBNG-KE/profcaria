        ...
        <div className="flex flex-col h-full overflow-hidden">
            ...
            <div className={`p-4 border-b shrink-0 flex items-center gap-3 overflow-x-auto ${isDark ? 'border-neutral-800' : 'border-neutral-200'}`} style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                ...
                <div className="ml-auto relative">
                    ...
                    >
                        <div className={`w-2 h-2 rounded-full ${selectedModel === 'gemini-1.5-pro' ? 'bg-[#ED3EB3]' : 'bg-yellow-500'}`} />
                                    ...
                                    {models.map(model => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <span className={`text-[10px] font-black uppercase tracking-widest px-2 py-0.5 rounded-md ${model.badge === 'Standard' ? (isDark ? 'bg-[#ED3EB3]/20 text-[#35D7DC]' : 'bg-[#ED3EB3]/10 text-[#ED3EB3]') : (isDark ? 'bg-yellow-500/10 text-yellow-500' : 'bg-yellow-50 text-yellow-600')}`}>
                                                    {model.badge}
                                                </span>
                                            </button>
                                        );
