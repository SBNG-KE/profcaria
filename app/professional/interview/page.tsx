        ...
        <div className="p-8">
            <div className="relative z-10 max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                {loading ? (
                    ...
                    <div className={`border rounded-[40px] overflow-hidden ${isDark ? 'bg-[#0D211A] border-slate-800' : 'bg-white border-neutral-200 shadow-sm'}`}>
            ...
            {selectedInterview && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    <div className={`relative w-full max-w-2xl border rounded-[40px] shadow-2xl overflow-hidden animate-in zoom-in-95 ${isDark ? 'bg-[#0D211A] border-slate-700' : 'bg-white border-neutral-200'}`}>
            ...
            {showJoinConfirm && interviewToJoin && (
                <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
                    ...
                    <div className={`relative w-full max-w-md border rounded-[40px] shadow-2xl overflow-hidden animate-in zoom-in-95 ${isDark ? 'bg-[#0D211A] border-slate-700' : 'bg-white border-neutral-200'}`}>
                        <div className={`p-8 border-b flex items-center justify-between ${isDark ? 'border-white/5' : 'border-neutral-200'}`}>
                            <div className="flex items-center gap-4">
