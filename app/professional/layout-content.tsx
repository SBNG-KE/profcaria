...
export default function ProfessionalLayoutContent({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className={`professional-scope flex h-screen font-sans overflow-hidden transition-colors duration-300 relative ${isDark ? 'bg-[#0D211A] text-neutral-200 selection:bg-white/30' : 'bg-white text-neutral-900 selection:bg-black/20'}`}>
            ...
            <main className="flex-1 relative flex flex-col h-full overflow-hidden">
                ...
                <div className="flex-1 flex min-h-0 overflow-hidden">
                    {/* Main Content */}
                    <div className={`flex-1 overflow-y-auto ${pathname === '/professional/notifications' ? 'px-0 pb-20 md:pb-0' : 'px-4 md:px-6 pb-20 md:pb-6'}`} style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                        {children}
                    </div>
