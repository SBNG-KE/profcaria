        ...
        <>
                ...
                {isLoading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 overflow-y-auto pb-20">
                        {contracts.map(contract => (
                            <div key={contract.id} className="group bg-[#061D20] border border-slate-800 rounded-[32px] p-6 hover:border-blue-500/30 transition-all relative overflow-hidden flex flex-col cursor-default">
            ...
            {isUploadModalOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    <div className="relative w-full max-w-lg bg-[#061D20] border border-slate-700 rounded-[32px] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
