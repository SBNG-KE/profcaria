...
export default function WorkClient() {
  ...
  return <section className="mx-auto max-w-6xl p-5 sm:p-8">
    <div className="rounded-[32px] bg-[var(--accent-primary)] p-7 text-[var(--text-inverse)] sm:p-10">
      ...
      {!organizations.length && <p className="mt-5 max-w-xl text-sm leading-6 opacity-70">Create a work account for an organisation you own, or wait for an invitation from an employer. Your personal Profcaria identity remains unchanged.</p>}
    </div>
