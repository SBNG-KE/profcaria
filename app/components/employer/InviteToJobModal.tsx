                ...
                {!success && (
                    <div className={`px-6 py-4 flex items-center justify-end gap-3 border-t ${isDark ? 'border-neutral-800 bg-neutral-900/50' : 'border-neutral-200 bg-neutral-50/50'}`}>
                        ...
                        <button
                            ...
                            className="px-5 py-2 rounded-lg text-sm font-bold bg-[#104B52] text-white hover:bg-[#104B52] dark:bg-white dark:text-black dark:hover:bg-neutral-200 transition-all shadow-lg shadow-black/10 dark:shadow-none disabled:opacity-50 flex items-center gap-2"
                        >
