...
function GoogleMark() {
  return <svg aria-hidden="true" viewBox="0 0 48 48" className="h-5 w-5 shrink-0">
    <path fill="#ED3EB3" d="M43.6 20.5H42V20H24v8h11.3A12 12 0 0 1 12.7 32l-6.6 5.1A20 20 0 0 0 44 24c0-1.2-.1-2.3-.4-3.5Z" />
    <path fill="#ED3EB3" d="m6.1 10.9 6.6 4.8A12 12 0 0 1 32 12.1l5.8-5.7A20 20 0 0 0 6.1 10.9Z" />
    <path fill="#006B76" d="M24 44c5.4 0 10-1.8 13.4-4.9L31.2 34a12 12 0 0 1-18.5-6l-6.6 5.1A20 20 0 0 0 24 44Z" />
    <path fill="#00A7B5" d="M43.6 20.5H42V20H24v8h11.3a12 12 0 0 1-4.1 6l6.2 5.1C41 35.8 44 30.8 44 24c0-1.2-.1-2.3-.4-3.5Z" />
  </svg>;
}
