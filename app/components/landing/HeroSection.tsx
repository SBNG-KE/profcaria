...
export default function HeroSection() {
    ...
    return (
        <section className={`relative min-h-[100vh] flex flex-col justify-center items-center text-center overflow-hidden`}>
            ...
            {isDark && (
                <>
                    <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#ED3EB3]/10 rounded-full blur-[120px] pointer-events-none" />
                    <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#104B52]/20 rounded-full blur-[120px] pointer-events-none" />
                </>
            )}
        </section>
    );
