        ...
        <section className={`relative flex flex-col items-center pt-8 pb-0 px-4 sm:px-8 md:px-24 z-10 overflow-hidden`}>
            ...
            <div className="absolute top-0 left-0 right-0 h-16 flex justify-center opacity-70">
                ...
                <motion.div 
                    ...
                    className={`w-1 origin-top ${isDark ? 'bg-gradient-to-b from-[#738D7D]/0 via-[#738D7D] to-[#738D7D]' : 'bg-gradient-to-b from-[#143D33]/0 via-[#143D33] to-[#143D33]'}`}
                />
                {/* Left Stream */}
                <motion.div 
                    ...
                    className={`absolute top-0 w-[2px] origin-top skew-x-[-15deg] ${isDark ? 'bg-gradient-to-b from-[#738D7D]/0 to-[#738D7D]' : 'bg-gradient-to-b from-[#143D33]/0 to-[#143D33]'}`}
                />
                {/* Right Stream */}
                <motion.div 
                    initial={{ height: 0, x: 100 }}
            ...
            <div className="mt-16 mb-4 relative z-10 w-full max-w-7xl mx-auto flex flex-col items-center text-center">
                ...
                <motion.div
                    ...
                    className={`relative w-40 h-40 rounded-full border-4 flex items-center justify-center mb-16 shadow-[0_0_80px_rgba(20,61,51,0.6)]
                        ${isDark ? 'bg-[#0D211A] border-white' : 'bg-white border-[#143D33]'}
                    `}
                >
                    <div className="absolute inset-2 rounded-full border border-dashed animate-spin-slow opacity-50" />
                    <Cpu size={56} className={isDark ? 'text-white' : 'text-[#143D33]'} />
                </motion.div>
                ...
                >
                    <h2 className={`text-5xl md:text-7xl font-black uppercase tracking-tighter leading-none mb-8 ${isDark ? 'text-white' : 'text-black'}`}>
                        The <span className={`font-pixel ${isDark ? 'text-white' : 'text-[#143D33]'}`}>Overseer</span> AI.
                    </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full text-left">
                    {[
                        ...
                        <motion.div
                            ...
                            `}
                        >
                            <feature.icon className={`mb-8 ${isDark ? 'text-white' : 'text-[#143D33]'}`} size={40} />
