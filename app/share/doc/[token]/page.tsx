...
export default async function SharedDocPage({ params }: { params: Promise<{ token: string }> }) {
    ...
    if (!payload) {
        return (
            <div className="min-h-screen bg-[#0D211A] flex items-center justify-center p-8 text-center">
    ...
    return (
        <div className="min-h-screen bg-[#0D211A] text-slate-300 font-sans py-12 px-4 md:px-0">
            <div className="max-w-2xl mx-auto bg-[#0D211A] border border-slate-800 rounded-[32px] overflow-hidden shadow-2xl">
                {/* Header */}
