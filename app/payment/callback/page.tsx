...
function CallbackContent() {
    ...
    return (
        <div className="min-h-screen bg-[#0D211A] flex items-center justify-center p-4">
            <div className="bg-[#0D211A] border border-slate-800 p-8 rounded-3xl max-w-sm w-full text-center space-y-6 shadow-2xl">
                {status === 'verifying' && (
                    <>
...
export default function PaymentCallbackPage() {
    return (
        <Suspense fallback={<div className="min-h-screen bg-[#0D211A]" />}>
            <CallbackContent />
        </Suspense>
    );
}
