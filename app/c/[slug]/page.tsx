...
export default function PublicCompanyProfilePage() {
    ...
    if (loading) {
        return <div className="min-h-screen bg-[#061D20] flex items-center justify-center"><Loader2 className="text-white animate-spin" size={48} /></div>;
    }

    if (error || !company) {
        return (
            <div className="min-h-screen bg-[#061D20] flex flex-col items-center justify-center text-center p-4">
    ...
    return (
        <div className="min-h-screen bg-[#061D20] text-white">
            {/* Simple Header */}
            <nav className="fixed top-0 inset-x-0 z-50 bg-[#061D20]/80 backdrop-blur-md border-b border-white/5 h-16 flex items-center justify-between px-6">
                <Link href="/" aria-label="Profcaria home"><ProfcariaLogo className="text-xl" markClassName="text-[#ED3EB3]" /></Link>
