            ...
            await resend.emails.send({
                ...
                html: `
                    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                        <div style="background: linear-gradient(135deg, #081812 0%, #153027 100%); border-radius: 16px; padding: 32px; margin-bottom: 24px;">
                            <h1 style="color: #FBF8F0; font-size: 24px; margin: 0 0 8px 0;">Reference Request</h1>
                            <p style="color: #CFC4B3; font-size: 14px; margin: 0;">via Profcaria Employment Network</p>
                        </div>
                        
                        <div style="background: #FBF8F0; border-radius: 12px; padding: 24px; margin-bottom: 24px;">
                            <p style="color: #153027; font-size: 16px; line-height: 1.6; margin: 0 0 16px 0;">
                            ...
                            ${customMessage ? `
                                <div style="background: #FBF8F0; border-left: 4px solid #587565; padding: 16px; margin: 16px 0; border-radius: 0 8px 8px 0;">
                                    <p style="color: #77877F; font-size: 14px; margin: 0; font-style: italic;">"${customMessage}"</p>
                                </div>
                            ` : ''}
                        </div>
                        
                        <div style="background: #FBF8F0; border: 1px solid #F4F0E6; border-radius: 12px; padding: 24px; margin-bottom: 24px;">
                            <h2 style="color: #081812; font-size: 16px; font-weight: 600; margin: 0 0 16px 0; text-transform: uppercase; letter-spacing: 0.5px;">
                                Questions They'd Like Answered
                            </h2>
                            <ul style="color: #486058; font-size: 14px; line-height: 1.8; margin: 0; padding-left: 20px;">
                        ...
                        <div style="border-top: 1px solid #F4F0E6; padding-top: 24px;">
                ...
                await resend.emails.send({
                    ...
                    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                        <div style="background: linear-gradient(135deg, #3D6254 0%, #587565 100%); border-radius: 16px; padding: 32px; margin-bottom: 24px;">
                            <h1 style="color: #FBF8F0; font-size: 24px; margin: 0 0 8px 0;">Reference Request Sent ✓</h1>
                        ...
                        <div style="background: #FFF0FB; border: 1px solid #738D7D; border-radius: 12px; padding: 16px; margin-bottom: 24px;">
                            <p style="color: #143D33; font-size: 14px; margin: 0;">
